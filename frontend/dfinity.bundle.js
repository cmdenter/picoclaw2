...
function toReadableString(x) {
  const str = JSON.stringify(x, (_key, value4) => typeof value4 === "bigint" ? `BigInt(${value4})` : value4);
...
field ${k} -> ${e.message}`);
      ...
      _buildTypeTableImpl(T) {
        ...
        const fields = this._fields.map(([key, value4]) => concat2(lebEncode(idlLabelToId(key)), value4.encodeType(T)));
...
variant ${k} -> ${e.message}`);
      ...
      decodeValue(b, t) {
        ...
        for (const [key, expectType] of this._fields) {
          if (idlLabelToId(wireHash) === idlLabelToId(key)) {
            const value4 = expectType.decodeValue(b, wireType);
            return { [key]: value4 };
          }
        }
      ...
      valueToString(x) {
        for (const [name, type] of this._fields) {
          if (x.hasOwnProperty(name)) {
            const value4 = type.valueToString(x[name]);
            if (value4 === "null") {
              return `variant {${name}}`;
            } else {
...
var require_constants = __commonJS({
  "node_modules/borc/src/constants.js"(exports) {
    ...
    exports.SYMS = {
      NULL: /* @__PURE__ */ Symbol("null"),
      UNDEFINED: /* @__PURE__ */ Symbol("undef"),
      PARENT: /* @__PURE__ */ Symbol("parent"),
      BREAK: /* @__PURE__ */ Symbol("break"),
        ...
        switch (typeof value4) {
          ...
          case "object":
            if (value4 === null) {
              ...
              return cbor4.array(value4.map((x) => this._serializer.serializeValue(x)));
            } else if (BufferClasses.find((x) => value4 instanceof x)) {
              ...
              return cbor4.map(m, this._stable);
            } else {
              const m = /* @__PURE__ */ new Map();
...
function _abool2(value4, title = "") {
  if (typeof value4 !== "boolean") {
    const prefix = title && `"${title}"`;
    throw new Error(prefix + "expected boolean, got type=" + typeof value4);
  }
  return value4;
}
function _abytes2(value4, length, title = "") {
  const bytes = isBytes(value4);
  const len = value4?.length;
  const needsLen = length !== void 0;
  if (!bytes || needsLen && len !== length) {
    const prefix = title && `"${title}" `;
    const ofLen = needsLen ? ` of length ${length}` : "";
    const got = bytes ? `length=${len}` : `type=${typeof value4}`;
...
function pointG1FromBytes(bytes) {
  ...
  if (value4.length === 48 && compressed) {
    ...
    const x = bytesToNumberBE(value4.subarray(0, L));
    const y = bytesToNumberBE(value4.subarray(L));
    if (infinity) {
      if (x !== _0n7 || y !== _0n7)
...
function pointG2FromBytes(bytes) {
  ...
  if (value4.length === 96 && compressed) {
    if (infinity) {
      if (value4.reduce((p, c) => p !== 0 ? c + 1 : c, 0) > 0) {
        throw new Error("invalid G2 point: compressed");
      }
      return { x: Fp2.ZERO, y: Fp2.ZERO };
    }
    const x_1 = slc(value4, 0, L);
    const x_0 = slc(value4, L, 2 * L);
    ...
    const x1 = slc(value4, 0 * L, 1 * L);
    const x0 = slc(value4, 1 * L, 2 * L);
    const y1 = slc(value4, 2 * L, 3 * L);
    const y0 = slc(value4, 3 * L, 4 * L);
...
var init_expirableMap = __esm({
  "node_modules/@dfinity/agent/lib/esm/utils/expirableMap.js"() {
    __classPrivateFieldSet = function(receiver, state, value4, kind, f) {
...
var init_public_key = __esm({
  "node_modules/@dfinity/agent/lib/esm/public_key.js"() {
    init_der();
    __classPrivateFieldSet2 = function(receiver, state, value4, kind, f) {
      if (kind === "m") throw new TypeError("Private method is not writable");
      if (kind === "a" && !f) throw new TypeError("Private accessor was defined without a setter");
      if (typeof state === "function" ? receiver !== state || !f : !state.has(receiver)) throw new TypeError("Cannot write private member to an object whose class did not declare it");
      return kind === "a" ? f.call(receiver, value4) : f ? f.value = value4 : state.set(receiver, value4), value4;
...
var init_backoff = __esm({
  "node_modules/@dfinity/agent/lib/esm/polling/backoff.js"() {
    __classPrivateFieldSet3 = function(receiver, state, value4, kind, f) {
      if (kind === "m") throw new TypeError("Private method is not writable");
      if (kind === "a" && !f) throw new TypeError("Private accessor was defined without a setter");
      if (typeof state === "function" ? receiver !== state || !f : !state.has(receiver)) throw new TypeError("Cannot write private member to an object whose class did not declare it");
      return kind === "a" ? f.call(receiver, value4) : f ? f.value = value4 : state.set(receiver, value4), value4;
...
var init_http = __esm({
  "node_modules/@dfinity/agent/lib/esm/agent/http/index.js"() {
    ...
    init_transforms();
    init_types2();
    __classPrivateFieldSet4 = function(receiver, state, value4, kind, f) {
      if (kind === "m") throw new TypeError("Private method is not writable");
      if (kind === "a" && !f) throw new TypeError("Private accessor was defined without a setter");
      if (typeof state === "function" ? receiver !== state || !f : !state.has(receiver)) throw new TypeError("Cannot write private member to an object whose class did not declare it");
      return kind === "a" ? f.call(receiver, value4) : f ? f.value = value4 : state.set(receiver, value4), value4;
...
// node_modules/@dfinity/identity/lib/esm/identity/delegation.js
var __classPrivateFieldSet7 = function(receiver, state, value4, kind, f) {
  if (kind === "m") throw new TypeError("Private method is not writable");
  if (kind === "a" && !f) throw new TypeError("Private accessor was defined without a setter");
  if (typeof state === "function" ? receiver !== state || !f : !state.has(receiver)) throw new TypeError("Cannot write private member to an object whose class did not declare it");
  return kind === "a" ? f.call(receiver, value4) : f ? f.value = value4 : state.set(receiver, value4), value4;
...
var __classPrivateFieldSet8 = function(receiver, state, value4, kind, f) {
  if (kind === "m") throw new TypeError("Private method is not writable");
  if (kind === "a" && !f) throw new TypeError("Private accessor was defined without a setter");
  if (typeof state === "function" ? receiver !== state || !f : !state.has(receiver)) throw new TypeError("Cannot write private member to an object whose class did not declare it");
  return kind === "a" ? f.call(receiver, value4) : f ? f.value = value4 : state.set(receiver, value4), value4;
